    ...
    function filter_submit_review_page_content( string $content ): string {
        ...
        <div class="mass-reviews container container-px">
            <div class="review-intro">
                <h1 class="bold"><?php echo esc_html__('Η γνώμη σου είναι σημαντική για εμάς', 'nutrisslim-suite'); ?></h1>
                <p><?php echo esc_html__('Στη Nature\'s Finest προσπαθούμε πάντα να παρέχουμε τα καλύτερα προϊόντα και υπηρεσίες στους πολύτιμους πελάτες μας. Θα ήθελες να αξιολογήσεις την τελευταία σου αγορά;', 'nutrisslim-suite'); ?></p>
                <p><?php echo esc_html__('Ως ένδειξη εκτίμησης για τον χρόνο σου, θα σου στείλουμε ένα ειδικό δωράκι μαζί με την παραγγελία σου!', 'nutrisslim-suite'); ?></p>

                <h4><?php echo esc_html__('Η παραγγελία σου', 'woocommerce'); ?></h4>
                ...
                <h4><?php echo esc_html__('Αξιολόγησε και γράψε κριτική για την αγορά σου', 'nutrisslim-suite'); ?></h4>
            </div>
            ...
            <div class="form">
                <div class="nf-review_form">
                    <div class="review_fields">
                        ...
                        <textarea name="review_review" id="review_text" cols="30" rows="5" placeholder="<?php echo esc_attr__('Πες μας τι πιστεύεις','nutrisslim-suite'); ?>"></textarea>
                        <button id="send_reviews"><?php echo esc_html__('Αποστολή','woocommerce'); ?></button>
                    </div>
                </div>
            </div>
        </div>
